defmodule StandYupWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StandYupWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StandYupWeb.Gettext, "errors", msg, opts)
    end
  end
