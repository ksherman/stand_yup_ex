defmodule StandYup.OrganizationsTest do
  use StandYup.DataCase

  alias StandYup.Organizations

  describe "organizations" do
    alias StandYup.Organizations.Organization

    import StandYup.OrganizationsFixtures
